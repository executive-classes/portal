<template>
    <v-navigation-drawer v-model="Customizer_drawer" app temporary :right="!$vuetify.rtl">
        ...
        <div class="px-4 py-4">
            ...
            <v-switch v-model="setHorizontalLayout" hide-details class="mt-2" label="Horizontal"></v-switch>
        </div>
        ...
        <div class="px-4 py-4">
            ...
            <v-item-group v-model="setNavbarColor">
                <v-item v-for="color in navbarColors" :key="color" :value="color" class="mt-2">
                    <template v-slot="{ active, toggle }">
                        <v-avatar
                            :class="active && 'v-sidebar_active'"
                            :color="color"
